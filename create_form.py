...
class createForm(Form):
    ...
    deliveryStatus = SelectField('Delivery Status', [validators.DataRequired()],
                                 choices=[('D', 'Delivered'), ('DG', 'Delivering'), ('DY', 'Delayed'), ('P', 'Processing')], default='DY')
    ...
    trackingNum = StringField('Tracking Number', [validators.Length(min=1, max=150), validators.DataRequired()])
