...
@app.route("/crime")
def crime():
    return render_template("shop_crime.html")


@app.route("/children")
def children():
    return render_template("shop_children.html")


@app.route("/fiction")
def fiction():
    return render_template("shop_fiction.html")


@app.route("/manga")
def manga():
    return render_template("shop_manga.html")
